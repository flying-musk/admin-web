  ...
  <div id="pre-order-detail">
    ...
    <div class="rounded bg-white" v-show="!state.loading">
      <div class="space-y-1 detail-page">
        ...
        <div
          v-if="false"
          class="px-3 py-2 from-primary-50 to-primary-400 bg-gradient-to-tr flex items-center justify-between rounded-t"
          :class="{
          ...
          <small
            class="px-2 text-primary-500 bg-white border-primary-50 border shadow rounded-full tracking-widest"
            :class="{
        ...
        <div class="bg-gray-100 space-y-1 p-1" v-if="false">
          <div class="flex items-center gap-x-1">
            <div
              class="w-5 h-5 text-xs rounded-full flex justify-center items-center border border-primary-500 bg-white text-primary-500">
              送
            </div>
        ...
        <div class="bg-gray-100 space-y-1">
          <div class="bg-gray-100 border">
            <div
              class="flex items-center justify-between pr-2 py-1 shadow bg-white">
              ...
              <div
                ...
                <div class="grid grid-cols-1">
                  <div class="flex gap-y-2 border-b items-center pr-2 py-1">
                    <div
                      class="tracking-widest text-primary-700 flex text-md items-center gap-x-1 w-full">
                      <small
                  ...
                  <div class="flex flex-col col-span-3">
                    <div class="flex flex-col space-y-1 p-1 px-2 text-gray-600">
                      <div class="flex flex-row text-sm">
                        <p
                          class="flex items-center justify-between text-xs flex-1 text-gray-500">
                          <span>商品品項</span>
